...
import { FinderIcon, FolderIcon } from '@/shared/ui/macos/MacOSIcons';
...
import { useDesktopStore, type ShellPanel } from '@/shared/store/desktopStore';
...
import { PlatformUserCenterWindow } from "./PlatformUserCenterWindow";
import "./macShell.css";
...
function AppShell() {
  ...
  return (
    ...
    >
      ...
      <PlatformUserCenterWindow
        open={activeWindow === "platform-users"}
        onClose={closeShellWindow}
        triggerRef={windowOpenerRef}
      />
      <LoginWindow />
