/**
 * 模块注册表 — DeepDiagram Pro 平台的统一模块声明。
 *
...
export const moduleRegistry: ModuleRegistration[] = [
  {
    path: '/diagram',
    navLabel: '思维导图',
    title: 'SmartDiagram 智能绘图',
    tagline: '对话即绘图',
    description:
      '用自然语言描述你的想法，AI 自动选择最合适的引擎生成图表。思维导图、流程图、时序图、数据可视化，生成后可在画布上继续编辑、版本管理与导出。',
    highlights: ['自然语言生成图表', '五种绘图引擎智能路由', '画布实时编辑与导出'],
    icon: BrainCircuit,
    accent: {
      gradientFrom: '#6366f1',
      gradientTo: '#22d3ee',
